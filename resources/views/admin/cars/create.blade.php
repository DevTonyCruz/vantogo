            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ url('admin/cars/') }}" method="POST">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control{{ $errors->has('brand') ? ' is-invalid' : '' }}"
                                id="brand" name="brand" placeholder="Ingrese la marca" value="{{ old('brand') }}"
                                required>
                            @if ($errors->has('brand'))
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" id="model" name="model"
                                ...
                                placeholder="Ingrese el modelo" value="{{ old('model') }}" required>
                            @if ($errors->has('model'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" id="registration" name="registration"
                                ...
                                placeholder="Ingrese las placas" value="{{ old('registration') }}"
                                required>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="numeric" id="capacity" name="capacity"
                                class="form-control{{ $errors->has('capacity') ? ' is-invalid' : '' }}"
                                placeholder="Ingrese los asientos disponibles" value="{{ old('capacity') }}" required>
