                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item">
                            <a href="{{ url('admin/routes') }}">Vehiculos</a>
                        </li>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ url('admin/routes/' . $route->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}"
                                id="code" name="code" placeholder="Ingrese el código" value="{{ $route->code }}"
                                required>
                            @if ($errors->has('code'))
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" id="origin" name="origin"
                                ...
                                placeholder="Ingrese el origen" value="{{ $route->origin }}" required>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" id="destination" name="destination"
                                ...
                                placeholder="Ingrese el destino" value="{{ $route->destination }}"
                                required>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="number" id="price" name="price"
                                ...
                                placeholder="Ingrese el precio" value="{{ $route->price }}" required>
                            @if ($errors->has('price'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="numeric" id="kilometer" name="kilometer"
                                ...
                                placeholder="Ingrese la distancia en Km" value="{{ $route->kilometer }}" required>
                    ...
                    <div class="form-group align-items-center row mb-3">
                        ...
                        <div class="col-4">
                            <input type="numeric" id="hour" name="hour"
                                ...
                                placeholder="Ingrese las horas" value="{{ $route->hour }}" required>
                            @if ($errors->has('hour'))
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-4">
                            <input type="numeric" id="minutes" name="minutes"
                                ...
                                placeholder="Ingrese los minutos" value="{{ $route->minute }}" required>
