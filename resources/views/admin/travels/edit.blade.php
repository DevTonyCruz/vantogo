    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ url('admin/travels/' . $travel->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}"
                                id="code" name="code" placeholder="Ingrese el código" value="{{ $travel->code }}"
                                required>
                            @if ($errors->has('code'))
                        ...
                        <div class="col-9">
                            <select class="form-control{{ $errors->has('route_id') ? ' is-invalid' : '' }} select2"
                                ...
                                <option value="{{ $route->id }}"
                                    {{ ($travel->route_id == $route->id ? "selected":"") }}>{{ $route->code }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <select class="form-control{{ $errors->has('car_id') ? ' is-invalid' : '' }} select2"
                                ...
                                @foreach ($cars as $car)
                                <option value="{{ $car->id }}"
                                    {{ ($travel->car_id == $car->id ? "selected":"") }}>{{ $car->brand . ' - ' . $car->registration }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-9">
                            <select class="form-control{{ $errors->has('driver_id') ? ' is-invalid' : '' }} select2"
                                ...
                                <option value="{{ $driver->id }}"
                                    {{ ($travel->driver_id == $driver->id ? "selected":"") }}>{{ $driver->name . ' ' . $driver->first_last_name . ' ' . $driver->second_last_name }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" id="date" name="date"
                                ...
                                data-toggle="date-picker" data-single-date-picker="true" value="{!! \Carbon\Carbon::parse($travel->date)->format('m/d/Y') !!}" required>
                            @if ($errors->has('date'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" id="hour_ini" name="hour_ini"
                                ...
                                placeholder="Ingrese la hora de salida" value="{{ $travel->hour_ini }}"
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="text" id="hour_fin" name="hour_fin"
                                ...
                                placeholder="Ingrese la hora de salida" value="{{ $travel->hour_fin }}"
                                data-toggle="timepicker" data-show-meridian="false" required>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-9">
                            <input type="numeric" id="place" name="place"
                                ...
                                placeholder="Ingrese el lugar de salida" value="{{ $travel->place }}" required>
                            @if ($errors->has('place'))
                            <span class="invalid-feedback" role="alert">
